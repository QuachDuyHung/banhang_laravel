    ...
    <div id="content">
        <div class="row">
            <div class="col-sm-9">
                ...
                <div class="row">
                    <div class="col-sm-4">
                    <img src="resource/image/product/{{$sanpham->image}}" alt="" height="250">
                    </div>
                    <div class="col-sm-8">
                        <div class="single-item-body">
                        <h2 style="margin-bottom: 15px;">{{$sanpham->name}}</h2>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4" style="margin-bottom: 40px;">
                            <div class="single-item">
                                ...
                                <a href="{{route('chitietsanpham',$sptt->id)}}"><img src="resource/image/product/{{$sptt->image}}" alt="" height="200"></a>
                                </div>
                                <div class="single-item-body">
                    ...
                    <div class="widget-body">
                        <div class="beta-sales beta-lists">
                            <div class="media beta-sales-item">
                                <a class="pull-left" href="product.html"><img src="resource/assets/dest/images/products/sales/1.png" alt=""></a>
                            ...
                            <div class="media beta-sales-item">
                                <a class="pull-left" href="product.html"><img src="resource/assets/dest/images/products/sales/2.png" alt=""></a>
                                <div class="media-body">
                                    Sample Woman Top
                                    <span class="beta-sales-price">$34.55</span>
                                </div>
                            ...
                            <div class="media beta-sales-item">
                                <a class="pull-left" href="product.html"><img src="resource/assets/dest/images/products/sales/3.png" alt=""></a>
                                <div class="media-body">
                                    Sample Woman Top
                                    <span class="beta-sales-price">$34.55</span>
                                </div>
                            ...
                            <div class="media beta-sales-item">
                                <a class="pull-left" href="product.html"><img src="resource/assets/dest/images/products/sales/4.png" alt=""></a>
                                <div class="media-body">
                                    Sample Woman Top
                                    <span class="beta-sales-price">$34.55</span>
                                </div>
